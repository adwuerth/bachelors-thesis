...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_ccdf_read/vroom_qd1_read_latencies_mmio.csv};
        \addplot [mark=+,color=TUMDarkBlue, thick,mark repeat*=20] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_ccdf_read/vroom_qd1_read_latencies_vfio_4k.csv};
        \addplot [mark=x,color=TUMBlue, thick,mark repeat*=80] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_ccdf_read/vroom_qd1_read_latencies_vfio_2m.csv};
        \addplot [mark=triangle,color=TUMLightBlue, thick,mark repeat*=160] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_ccdf_read/vroom_qd1_read_latencies_vfio_1g.csv};
