...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMBlue] table[col sep=comma,x=key,y=iops] {data/qd1tn-1page/qd1tn_2MiB_mmio.csv};
        \addplot [mark=none,color=TUMGreen] table[col sep=comma,x=key,y=iops] {data/qd1tn-1page/qd1tn_4KiB_vfio.csv};
        \addplot [mark=none,color=TUMPurple] table[col sep=comma,x=key,y=iops] {data/qd1tn-1page/qd1tn_2MiB_vfio.csv};
