...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        \addplot [mark=triangle*,color=TUMBlue, thick,mark repeat*=50] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/lats_ccdf_2MiB_read/lats_qd1t1_2MiB_mmio_1Gbuf_read.csv};
        \addplot [mark=square*,color=TUMPurple, thick,mark repeat*=200] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/lats_ccdf_2MiB_read/lats_qd1t1_2MiB_vfio_1Gbuf_read.csv};
