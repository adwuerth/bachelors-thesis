...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMYellow] table[col sep=comma,x=key,y=iops] {data/qd1tn-512page/qd1tn_2MiB_mmio.csv};
        \addplot [mark=none,color=TUMRed] table[col sep=comma,x=key,y=iops] {data/qd1tn-512page/qd1tn_4KiB_vfio.csv};
        \addplot [mark=none,color=TUMBlue] table[col sep=comma,x=key,y=iops] {data/qd1tn-512page/qd1tn_2MiB_vfio.csv};
