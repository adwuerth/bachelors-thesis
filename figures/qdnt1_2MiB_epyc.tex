...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMBlue] table[col sep=comma,x=key,y expr=\thisrow{iops}/1000] {data/qdnt1_2MiB_epyc/qdnt1_2MiB_mmio.csv};
        ...
        \addplot [mark=none,color=TUMPurple] table[col sep=comma,x=key,y expr=\thisrow{iops}/1000] {data/qdnt1_2MiB_epyc/qdnt1_2MiB_vfio.csv};
