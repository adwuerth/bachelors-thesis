...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMYellow] table[col sep=comma,x=key,y=iops] {data/qdnt1_2MiB/qdnt1_2MiB_mmio.csv};
        ...
        \addplot [mark=none,color=TUMBlue] table[col sep=comma,x=key,y=iops] {data/qdnt1_2MiB/qdnt1_2MiB_vfio.csv};
