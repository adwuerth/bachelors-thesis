...
\begin{tikzpicture}
    ...
    \begin{axis}[
            ...
            legend entries={SPDK, vroom, \texttt{io\_uring}, \texttt{libaio}, \texttt{psync}, vroom mmio, vroom vfio, tuomas mmio, tuomas vfio},
        ...
        \addplot [mark=none,color=TUMYellow, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/vroom-mmio-write-cdf.csv};
        \addplot [mark=none,color=TUMTurquois, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/vroom-vfio-write-cdf.csv};


        \addplot [mark=none,color=TUMPurple, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/vroom-tuomas-mmio-write-cdf.csv};
        \addplot [mark=none,color=TUMRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/vroom-tuomas-vfio-write-cdf.csv};
