...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMYellow] table[col sep=comma,x=key,y=iops] {data/qd1tn_test/qd1tn_2MiB_mmio_8nvmes_1qd_512pg.csv};
        \addplot [mark=none,color=TUMRed] table[col sep=comma,x=key,y=iops] {data/qd1tn_test/qd1tn_4KiB_vfio_8nvmes_1qd_512pg.csv};
        \addplot [mark=none,color=TUMBlue] table[col sep=comma,x=key,y=iops] {data/qd1tn_test/qd1tn_2MiB_vfio_8nvmes_1qd_512pg.csv};
