...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=none,color=TUMYellow] table[col sep=comma,x=key,y=iops] {data/qdnt1_2MiB_8nvmes/qdnt1_2MiB_mmio_8nvmes.csv};
        ...
        \addplot [mark=none,color=TUMBlue] table[col sep=comma,x=key,y=iops] {data/qdnt1_2MiB_8nvmes/qdnt1_2MiB_vfio_8nvmes.csv};
