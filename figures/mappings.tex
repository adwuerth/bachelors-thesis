...
\begin{tikzpicture}
    ...
    \begin{axis}[
            ...
            legend entries={MMIO 256, MMIO, VFIO tr strict, VFIO pt strict, VFIO tr relaxed, VFIO pt relaxed},
        ...
        \addplot [mark=none,color=TUMLightRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/mappings/outputallocate_mmio_256.csv};
        \addplot [mark=none,color=TUMPurple, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/mappings/outputallocate_mmio_1024.csv};
        \addplot [mark=none,color=TUMTurquois, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/mappings/outputallocate_combined_1024.csv};
        \addplot [mark=none,color=TUMDarkGreen, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/mappings/outputallocate_combined_pt_1024.csv};
        \addplot [mark=none,color=TUMYellow, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/mappings/outputallocate_combined_nonstrict_1024.csv};
        \addplot [mark=none,color=TUMRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/mappings/outputallocate_combined_pt_nonstrict_1024.csv};
