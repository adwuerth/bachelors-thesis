...
\begin{tikzpicture}
    ...
    \begin{axis}[
            ...
            legend entries={2MDS 2MPS Strict, 2MDS 2MPS, 2MDS 4KPS Strict, 2MDS 4KPS, 4KDS 4KPS Strict, 4KDS 4KPS},
        ...
        \addplot [mark=none,color=TUMRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_im/latency_intmap_read_2mibds_2mibps_tn.csv};
        \addplot [mark=none,color=TUMDarkRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_im/latency_intmap_read_2mibds_2mibps_ts.csv};

        \addplot [mark=none,color=TUMGreen, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_im/latency_intmap_read_2mibds_4kibps_tn.csv};
        \addplot [mark=none,color=TUMDarkGreen, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_im/latency_intmap_read_2mibds_4kibps_ts.csv};

        \addplot [mark=none,color=TUMBlue, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_im/latency_intmap_read_4kibds_4kibps_tn.csv};
        \addplot [mark=none,color=TUMDarkBlue, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/latency_im/latency_intmap_read_4kibds_4kibps_ts.csv};
