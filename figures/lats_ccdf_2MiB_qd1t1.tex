...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        \addplot [mark=+,color=TUMDarkBlue, thick,mark repeat*=20] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/lats_ccdf_2MiB/lats_qd1t1_2MiB_mmio_1Gbuf.csv};
        \addplot [mark=none,color=TUMRed, thick] table[col sep=comma,x=latency,y expr=1-\thisrow{cdf}] {data/lats_ccdf_2MiB/lats_qd1t1_2MiB_vfio_1Gbuf.csv};
