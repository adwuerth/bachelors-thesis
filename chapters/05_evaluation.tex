...
\begin{figure}
    \centering
    \subcaptionbox {1 4KiB buffer per thread} {\includegraphics[width=\textwidth]{figures/qd1tn_1page} \label{fig:qd1tn-1page}}
    \subcaptionbox {1 2MiB buffer per thread} {\includegraphics[width=\textwidth]{figures/qd1tn_512page} \label{fig:qd1tn-512page}}
