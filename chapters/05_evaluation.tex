...
\begin{figure}
    \centering
    \subcaptionbox {Random write} {\includegraphics[width=0.99\textwidth]{figures/latency_ccdf_write} \label{fig:ccdf-write}}
    \subcaptionbox {Random read} {\includegraphics[width=0.99\textwidth]{figures/latency_ccdf_read} \label{fig:ccdf-read}}
