...
\begin{figure}
    ...
    \caption{Latencies of random writes on an emtied SSD with increasing host memory pages on the Intel system}
    \label{fig:med-ps}
\end{figure}
...
\begin{figure}
    ...
    \caption{Latencies of random writes on an emtied SSD with increasing host memory pages on the AMD system}
